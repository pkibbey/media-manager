...
const MediaThumbnail = memo(
  function MediaThumbnail({
    ...
    const category = item.file_types?.category || null;
    const isImg = item.file_types?.category === 'image';
    const isVid = item.file_types?.category === 'video';
            ...
            <Image
              ...
              onError={(e) => {
                ...
                if (target.parentElement) {
                  ...
                  fallback.className =
                    'flex flex-col items-center justify-center w-full h-full bg-secondary/30';
                  fallback.innerHTML = `
