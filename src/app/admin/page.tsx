              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-sm">
                    <div>Total Media Items: {analysisResponse.stats.total}</div>
                    <div>
        ...
        <TabsContent value="exif" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Metadata extraction statistics</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div>
                  ...
                  <div className="text-sm">
                    ...
                    <div>Completion: {exifResponse.stats.percentComplete}%</div>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="thumbnails" className="space-y-4 mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Status of thumbnail processing</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div>
