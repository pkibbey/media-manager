            ...
            <CardContent>
              {exifStats ? (
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-medium mb-2">About EXIF Processing</h3>
                    <p className="text-sm text-muted-foreground">
                      ...
                      metadata to enhance searchability and organization of your
                      media collection.
                    </p>
                  </div>
                </div>
        ...
        <TabsContent value="processing" className="space-y-4 mt-4">
          <Card>
            ...
            <CardFooter className="flex flex-wrap gap-2">
              <ActionButton
                action={() => processBatch()}
                disabled={exifStats?.remaining === 0 || isContinuousProcessing}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>How EXIF data extraction works</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2 text-sm">
                <p>
                  EXIF data extraction uses the <code>sharp</code> library to
                  efficiently extract metadata without decoding the full image.
                  The system:
                </p>
                <ul className="list-disc pl-5 space-y-1">
                  ...
                  <li>
                    Normalizes timestamps, GPS coordinates, and technical values
                  </li>
                  <li>Stores structured data for searching and organization</li>
                </ul>
              </div>
            </CardContent>
          </Card>
