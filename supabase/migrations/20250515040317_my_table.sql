...
CREATE UNIQUE INDEX media_types_mime_type_key ON public.media_types USING btree (mime_type);
...
alter table "public"."media_types" add constraint "media_types_mime_type_key" UNIQUE using index "media_types_mime_type_key";
